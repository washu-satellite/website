        ...
        <div className="flex-1">
            ...
            <div className={clsx(
                ...
                <div className={`flex flex-col items-center gap-8 justify-center max-w-[40rem] bg-[${colors.bg}] border-inherit border-[1px] p-8 -mt-[10rem] rounded-md`}>
                    ...
                    <p className={`font-medium text-[${colors.textDark}]`}>We'll send you quarterly emails about all of the awesome projects we're working on. For all the prospective members, we also include position openings</p>
