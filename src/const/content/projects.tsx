...
export const ProjectPages: { [K in any]: ProjectPageType } = {
    gs1: {
        project: {
            ...
            url: "https://bpb-us-w2.wpmucdn.com/sites.wustl.edu/dist/d/4409/files/2024/12/GS-1-Poster.pdf",
    ...
    airis: {
        project: {
            ...
            url: "https://bpb-us-w2.wpmucdn.com/sites.wustl.edu/dist/d/4409/files/2024/12/AIRIS-High-Precision-Optical-Follow-Up-Telescope-for-Gamma-Ray-Burst-Detection-with-ADAPT.pdf",
    ...
    scalar: {
        project: {
            ...
            description: "Our planned inaugural CubeSat mission. Leveraging strategic partnerships with other university CubeSat teams and the WashU Department of Physics, along with utilizing open-source hardware, we are on an accelerated trajectory to launch our first payload in the spring of 2026. It is designed to demonstrate on-orbit reconfigurable hybrid compute, a key technology for future, software-enabled missions.",
            contributors: 47,
            date: "Q4-2026",
    ...
    vector: {
        project: {
            ...
            url: "https://bpb-us-w2.wpmucdn.com/sites.wustl.edu/dist/d/4409/files/2024/12/VECTOR-A-3U-CubeSat-for-Educational-and-Algorithmic-Development-in-Space-Based-Optical-Imaging.pdf",
