            ...
            <div className={clsx(
                ...
                <div className={`flex z-10 flex-col items-center gap-8 justify-center max-w-[40rem] bg-background border-inherit border-[1px] p-8 -mt-[10rem] rounded-md`}>
                    ...
                    <div className="text-foreground/80 text-center">
                        <p className={`font-medium`}>All WashU students, regardless of major or level of experience, are welcome to participate in our organization.</p>
                        <br />
                        <p className={`font-medium`}>Applications for the spring 2026 season are currently open.</p>
                    </div>
